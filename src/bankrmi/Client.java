...
public class Client {
    ...
    public Client(String bankName) {
        ...
        try {
            ...
            bankobj=(Bank)Naming.lookup("rmi://localhost:7777/Nordea");
    ...
    private Command parse(String userInput) {
        ...
        // denna raden retuneras från parser till execute metoden som tar in en command parameter
        return new Command(commandName, userName, amount);
    }


    // command är en innre klass som finns under , denna command objektet retuneras från parser som tar in inkommande
    // tecken från tangenbordet som ska utföra olika operationer på clients konto
